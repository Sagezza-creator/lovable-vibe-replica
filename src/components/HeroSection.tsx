    ...
    <div className="min-h-screen relative overflow-hidden flex items-center pt-16">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`max-w-2xl ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-white leading-tight relative z-20">
            Свобода разума: Решите свои проблемы навсегда
          </h1>
          
          <p className="text-lg md:text-xl text-gray-100 mb-8 relative z-20">
          ...
          <div className="flex flex-col sm:flex-row gap-4 relative z-20">
            ...
            <Button asChild size="lg" variant="outline" className="text-white border-white hover:bg-white/10 relative z-20">
              <Link to="/approach">Узнать больше о методе</Link>
            </Button>
          </div>
          
          <div className="mt-16 flex flex-col md:flex-row justify-start gap-6 md:gap-12 stagger-animation relative z-20">
