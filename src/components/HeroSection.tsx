      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`max-w-2xl ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            <span className="text-blue-600">Свобода разума:</span>{' '}
            <span className="text-blue-600">Решите свои проблемы навсегда</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button asChild size="lg" variant="outline" className="text-gray-800 border-gray-800 hover:bg-gray-800/10 hover:text-gray-800">
