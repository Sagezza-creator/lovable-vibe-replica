...
const steps: Step[] = [
  ...
  {
    id: 3,
    title: "Эпигенетический подход",
    description: "Используя техники, основанные на эпигенетике, я идентифицирую эти подсознательные программы и «деактивирую» их."
  },
  {
    id: 4,
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="max-w-lg">
              ...
              <p className="text-gray-700 mb-6 md:mb-0">
                Узнайте подробнее о том, как эпигенетика помогает перепрограммировать нейронные связи и устранять негативные подсознательные программы.
              </p>
            </div>
