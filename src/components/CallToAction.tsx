...
const CallToAction = () => {
  ...
  return (
    <section 
      ref={sectionRef} 
      className="py-10 pb-1 bg-gradient-to-br from-secondary to-white relative overflow-hidden"
    >
      {/* Добавленное изображение с анимацией пульсации */}
      <img 
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className={`max-w-3xl mx-auto text-center flex flex-col h-full ${
          ...
          <div className="flex-1 flex flex-col justify-end items-center">
            <div className={`flex justify-center mb-6 ${isVisible ? 'animate-gentle-scale-in' : 'opacity-0'}`} 
