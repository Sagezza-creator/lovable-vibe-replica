...
const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer: "Многие клиенты отмечают первые изменения уже после первой коррекции. Полное решение проблемы обычно наступает после 2-4 встреч. Вы заметите, как меняется ваше восприятие ситуаций и реакции на привычные триггеры."
  },
];
