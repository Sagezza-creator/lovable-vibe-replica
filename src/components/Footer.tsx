        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <div className="flex flex-col gap-2">
              <href="https://t.me/Intelligence_client_bot" className="text-gray-600 hover:text-brand-500 flex items-center gap-2 transition-colors">
                <MessageSquare size={18} />
                Telegram-бот для записи
              </a>
              <href="https://t.me/SVOBODA_RAZUMA_BLOG" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand-500 flex items-center gap-2 transition-colors">
                <MessageSquare size={18} />
                Telegram канал "Свобода разума"
              </a>
              <href="https://youtube.com/@Свобода_разума" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-brand-500 flex items-center gap-2 transition-colors">
                <MessageSquare size={18} />
                YouTube
              </a>
            </div>
