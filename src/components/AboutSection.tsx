        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <motion.div 
                className="absolute top-0 right-0 transform translate-x-1/4 -translate-y-1/4 bg-white rounded-full p-4 shadow-lg"
              ...
              <motion.div 
                className="absolute bottom-0 left-0 transform -translate-x-1/4 translate-y-1/4 bg-white rounded-full p-4 shadow-lg"
                initial={{ scale: 0, rotate: 45 }}
                animate={{ scale: 1, rotate: 0 }}
          ...
          >
            <motion.h2 
              className="text-3xl md:text-4xl font-bold gradient-heading mb-6"
              variants={itemVariants}
            >
              Обо мне
            </motion.h2>
            ...
            <motion.div 
              ...
              variants={containerVariants}
            >
              {['Психология', 'Работа с подсознанием', 'Устранение блоков', 'Поведенческие паттерны'].map((tag, index) => (
                <motion.div 
                  key={index}
