        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          ...
          <div className={`lg:w-3/5 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0 translate-x-[50px]'}`}>
            ...
            <div className="space-y-4 text-gray-600">
              ...
              <p>
                Моя специализация — эпигенетический подход к решению психологических проблем. Я работаю с подсознанием, выявляя и устраняя глубинные причины ваших проблем, а не просто временно облегчая симптомы.
              </p>
              <p>
